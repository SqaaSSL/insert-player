...
- `configure-production-smoke-users.yml`: explicit-confirmation deep merge of launch-smoke markers onto two preselected verified OAuth users; it preserves the operator admin role and refuses an admin clone.
