...
const imagePath = '/assets/social-card-v11.jpg';
...
describe('approved photo-to-character social artwork', () => {
  it('ships the exact reviewed JPEG without regenerating it from the old gameplay template', () => {
    expect(SOCIAL_CARD_APPROVED_SHA256).toBe('f27111d43d5448e8627cd3435ae1ccd07704db45ac3697ef1b227bcc9bc144c6');
  ...
  it.each([
    ['public/assets/social-card-v11.jpg', 300_000],
    ['public/assets/social-card-v11.webp', 150_000],
  ...
  it('preserves the previous social cards', () => {
    for (const path of ['public/assets/social-card-v7.jpg', 'public/assets/social-card-v8.jpg', 'public/assets/social-card-v8.webp']) {
