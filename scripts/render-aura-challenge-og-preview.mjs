// Local visual fixture using the exact deployed template and font bytes.
...
import { buildAuraChallengeOgDocument, AURA_CHALLENGE_OG_WIDTH, AURA_CHALLENGE_OG_HEIGHT } from '../worker/src/auraChallengeOgTemplate.ts';
