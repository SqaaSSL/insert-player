export const LAUNCH_FILM = '/assets/insert-player-launch-aura-v19.mp4';
  ...
  return (
    <section className="product-entry__film" aria-labelledby="launch-film-title">
      ...
      >
        ...
        <track kind="captions" src="/assets/insert-player-launch-aura-v19-en.vtt" srcLang="en" label="English" />
