...
- Scene 2 (0.42-3.14s): Move a single red-and-gold cabinet seam from left to right, replacing the exact source portrait with the exact approved Player One upright cutout and its production arena. No generated intermediate can replace or redraw the fighter.
- Scene 3 (3.08-4.65s): As the announcer reaches `Player`, hold the canonical fighter on the right and assemble the official P1 mark plus `INSERT PLAYER` across the open left field.
...
keyMessage: Your generated fighter actually fights across a real arcade roster.
focal: Player One, four global opponents, four stages, and four real exchanges.
