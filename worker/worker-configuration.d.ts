/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: a007171ad2f30493e1b6f59c23b06a45)
...
interface __BaseEnv_Env {
	...
	GENERATION_API_BASE_URL: string;
	GEMINI_TRANSPORT: string;
	METERKEY_BASE_URL: string;
	PIXCLI_BASE_URL: string;
	CLERK_ISSUER: string;
	...
	GENERATION_JOB_SIGNING_SECRET: string;
	CLERK_BACKEND_AUTH_BRIDGE_SECRET: string;
	IMAGE_PROCESSOR: DurableObjectNamespace<import("./src/index").ImageProcessorContainer>;
	MATCH_ROOM: DurableObjectNamespace<import("./src/index").MatchRoom>;
	BATTLE_FINISHER: Workflow<Parameters<import("./src/index").BattleFinisherWorkflow['run']>[0]['payload']>;
	FIGHTER_GENERATION: Workflow<Parameters<import("./src/index").FighterGenerationWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ImageProcessorContainer" | "MatchRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CORS_ORIGIN" | "PUBLIC_APP_NAME" | "PUBLIC_APP_SHORT_NAME" | "PUBLIC_SOCIAL_CARD_PATH" | "TURNSTILE_REQUIRED" | "TURNSTILE_ACTION" | "TURNSTILE_HOSTNAMES" | "ANONYMOUS_ROOKIE_ENABLED" | "GENERATION_API_BASE_URL" | "GEMINI_TRANSPORT" | "METERKEY_BASE_URL" | "PIXCLI_BASE_URL" | "CLERK_ISSUER" | "CLERK_AUTHORIZED_PARTIES" | "STRIPE_ACCOUNT_ID" | "STRIPE_PRICE_STARTER" | "STRIPE_PRICE_VERSUS" | "STRIPE_PRICE_ARCADE" | "METERKEY_API_KEY" | "GEMINI_API_KEY" | "GOOGLE_MAPS_SERVER_KEY" | "FAL_API_KEY" | "RUNWAY_API_KEY" | "FREEPIK_API_KEY" | "LUDO_API_KEY" | "PIXCLI_API_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "CLERK_WEBHOOK_SIGNING_SECRET" | "CLERK_SECRET_KEY" | "TURNSTILE_SECRET_KEY" | "ANONYMIZATION_SECRET" | "GENERATION_JOB_SIGNING_SECRET" | "CLERK_BACKEND_AUTH_BRIDGE_SECRET">> {}
}
